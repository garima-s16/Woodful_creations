...
if "%VENV_OK%"=="true" (
    (
        echo from app.platform.database.database import Base, engine
...
if "%REDIS_CONFIGURED%"=="false" (
    ...
    (
        echo import redis
        echo from app.platform.configuration.config import settings
        echo try:
...
if "%DRIVE_CONFIGURED%"=="false" (
    ...
    (
        echo from app.platform.storage.storage import get_storage_backend
        echo try:
...
if "%GEMINI_CONFIGURED%"=="false" (
    ...
    (
        echo from app.platform.database.database import SessionLocal
...
if "%SMTP_CONFIGURED%"=="false" (
    ...
    if "!TEST_EMAIL_TO!"=="" (
        ...
        (
            echo from app.modules.communications.services.email_service import EmailService
            echo try:
