...
def upgrade() -> None:
    ...
    op.create_index("ix_material_subcategories_name", "material_subcategories", ["name"])
    op.create_index("ix_material_subcategories_category_id", "material_subcategories", ["category_id"])
    ...
    op.create_index("ix_material_attribute_definitions_subcategory_id",
    ...
    op.create_index("ix_material_attribute_values_material_id", "material_attribute_values", ["material_id"])
    op.create_index("ix_material_attribute_values_attribute_definition_id",
                     "material_attribute_values", ["attribute_definition_id"])
    op.create_index("ix_material_attribute_values_value_number", "material_attribute_values", ["value_number"])
