"""Inventory domain tests - consolidated from 10 separate test_* files
covering materials, stock (decimal quantities, movement, ledger,
multi-location, transfers/adjustments, delete guards), purchases
(receipt status), and supplier-material relationships. Also covers
purchases/stock-dashboard exports, location hierarchy, an Excel-export
N+1 query regression guard, and the material-name interpreter (GET
/api/materials/interpret-name intelligent-defaults suggestion). Excel
import tests for purchases stay in their own test_inventory_import.py -
a genuinely different concern (bulk-import workflow), not general
inventory CRUD.
"""
import json
import pytest
...
# ===========================================================================
# From test_decimal_stock_quantities.py
# ===========================================================================
...
# ===========================================================================
# From test_material_active_and_stock_movement.py
# ===========================================================================
...
# ===========================================================================
# From test_material_hierarchy.py
# ===========================================================================
...
# ===========================================================================
# From test_multi_location_stock.py
# ===========================================================================
...
# ===========================================================================
# From test_purchase_receipt_status.py
# ===========================================================================
...
# ===========================================================================
# From test_stock_delete_guards.py
# ===========================================================================
...
# ===========================================================================
# From test_stock_transfer_adjustment.py
# ===========================================================================
...
# ===========================================================================
# From test_supplier_material.py
# ===========================================================================
...
# ===========================================================================
# Purchase partial-receipt tests (from the former partial_receipt segment)
# ===========================================================================
...
# ===========================================================================
# Reporting exports - purchases/stock dashboard (from test_client_hr_and_export_features.py)
# ===========================================================================
...
# ===========================================================================
# Location hierarchy (from test_client_hr_and_export_features.py)
# ===========================================================================
...
# ===========================================================================
# Purchases export N+1 query regression guard (from
# test_admin_and_ai_gateway.py's former test_excel_export_n_plus_one.py section)
# ===========================================================================
class _QueryCounter:
    def __init__(self):
        self.count = 0
...
# inventory-domain home.)
# ===========================================================================
# Material-name interpreter (from test_material_interpreter.py) - GET
# /api/materials/interpret-name, the material creation form's "intelligent
# defaults" suggestion. Confidence is never fabricated: "high" only fires
# when an existing Subcategory name genuinely matches, "medium" only when a
# similar existing Material's own subcategory is reused, "none" when nothing
# in the database backs a suggestion.
# ===========================================================================
