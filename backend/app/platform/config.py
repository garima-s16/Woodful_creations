...
class Settings(BaseSettings):
    ...
    # backend (app/platform/storage.py), separate from just checking
    ...
    # shared across processes). See app/platform/security.py.
    ...
    # limiter (app/platform/security.py, app/platform/middleware.py)
    ...
    # Production error/monitoring boundary - see app/platform/monitoring.py.
