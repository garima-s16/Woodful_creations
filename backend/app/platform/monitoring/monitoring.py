...
MONITORING_PROVIDER - see app/platform/configuration/config.py) and keeps
...
class _SentryProvider:
    ...
    app/platform/security/rate_limit.py."""
...
def reset_monitoring_provider() -> None:
    ...
    app/platform/security/rate_limit.py. The provider is a lazily-created,
