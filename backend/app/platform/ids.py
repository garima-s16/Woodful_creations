"""ID generation: the IdSequence table (strictly-increasing DB
sequence) and business-ID/short-ID/unique-code generation built on
top of it. Combines the former id_sequence.py and id_generator.py."""
...
class IdSequence(Base):
    ...
    generate_business_id below, in this same file). Deliberately minimal -
...
def generate_business_id(db: Session) -> str:
    ...
    an 11th character.
    """
    pass  # IdSequence defined in this same module
