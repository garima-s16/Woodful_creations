...
app/modules/sales/api/estimates.py / orders.py before any status write.
"""
...
# missing terminal states the business rules require, added here rather than
...
# record - further changes to its content
...
ESTIMATE_TRANSITIONS = {
    ...
    # tests/modules/sales/test_estimates_and_orders.py, which predates this
...
# Progress/Completed" minimum list, so it's
