...
class Estimate(BaseModel):
    ...
    # app/modules/catalog/pricing_priority.py) - applies to this estimate's line
...
class EstimateLineItem(BaseModel):
    ...
    pricing_rule_applied = Column(String(40), nullable=True)  # one of app.modules.catalog.pricing_priority.PRICING_RULES
