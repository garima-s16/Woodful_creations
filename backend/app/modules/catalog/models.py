...
class Product(BaseModel):
    ...
    see app/modules/documents/api.py - rather than a dedicated table,
    ...
    # tax_percent independently (see app/modules/sales/services.py's compute_totals function).
    ...
    def suggested_selling_price(self):
        """Uses the SAME formula as app.modules.catalog.pricing.compute_selling_rate
...
class RateCard(BaseModel):
    ...
    previous one (see app/modules/catalog/api.py), so any Estimate/
    ...
    # final numbers - see app/modules/catalog/pricing.py, the one place
