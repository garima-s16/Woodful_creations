...
from app.shared import (
    ...
    PDF_INK, PDF_BORDER, PDF_IVORY, LOGO_PATH, LOGO_ASPECT, pdf_text, fmt_date, mask_value, _contact_block,
)
...
def generate_salary_slip_pdf(slip: SalarySlip, db: Session) -> BytesIO:
    ...
    style_cmds = [
        ("BACKGROUND", (0, 0), (-1, 0), PDF_INK), ("TEXTCOLOR", (0, 0), (-1, 0), colors.white),
        ("FONTNAME", (0, 0), (-1, 0), "Helvetica-Bold"), ("FONTSIZE", (0, 0), (-1, 0), 8.5),
        ("ALIGN", (1, 0), (2, -1), "RIGHT"), ("ALIGN", (4, 0), (4, -1), "RIGHT"),
        ("GRID", (0, 0), (-1, -2), 0.5, PDF_BORDER),
        ("TOPPADDING", (0, 0), (-1, -1), 4), ("BOTTOMPADDING", (0, 0), (-1, -1), 4),
        ("FONTSIZE", (0, 1), (-1, -1), 9),
        ("BACKGROUND", (0, -1), (-1, -1), PDF_IVORY),
        ("FONTNAME", (0, -1), (-1, -1), "Helvetica-Bold"),
        ("LINEABOVE", (0, -1), (-1, -1), 0.75, PDF_INK),
        ("SPAN", (0, -1), (1, -1)),
    ]
    ...
    net_pay_value_style = ParagraphStyle("NetPayValue", parent=styles["body"], fontSize=13,
                                          textColor=PDF_INK, alignment=TA_RIGHT, fontName="Helvetica-Bold")
    net_table = Table(
    ...
    net_table.setStyle(TableStyle([
        ("BACKGROUND", (0, 0), (0, 0), PDF_INK),
        ("BACKGROUND", (1, 0), (1, 0), PDF_IVORY),
        ("BOX", (0, 0), (-1, -1), 0.75, PDF_INK),
