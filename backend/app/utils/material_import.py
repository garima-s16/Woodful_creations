"""Excel import for the Material Master - Family 103 section 6/7. Same
...
shared fuzzy-match logic as every other Family 103 importer (see
app.utils.client_matching.find_fuzzy_name_matches) so a typo like
...
# stocks, never generic Test/Demo/Reference placeholders (Family 103
# section 39's spirit applied to Materials).
EXAMPLE_ROWS = [
    {
...
def validate_and_match_row(row: dict, existing_by_name: dict, categories_by_name: dict,
    ...
    same shared fuzzy logic every other Family 103 importer uses. Never
    writes anything."""
    errors = []
