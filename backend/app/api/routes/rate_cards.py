...
from app.schemas.rate_card import RateCardCreate, RateCardUpdate, RateCardOverride, RateCardResponse
...
def list_rate_cards(
    ...
    return query.order_by(RateCard.category, RateCard.item_name).all()
