...
def verify_holiday_import() -> list:
    ...
    results = []
    try:
        from app.modules.hr.services import parse_uploaded_workbook
...
def verify_material_import() -> list:
    results = []
    try:
        from app.modules.inventory.imports import parse_uploaded_workbook
    except ImportError as e:
...
def verify_estimate_import() -> list:
    results = []
    try:
        from app.modules.sales.imports import parse_estimate_uploaded_workbook as parse_uploaded_workbook
    except ImportError as e:
