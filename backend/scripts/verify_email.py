...
def verify_email_generation() -> list:
    ...
    # -only FakeSettings into sys.modules["app.platform.configuration.config"] and never
    ...
    # needed here. The real app.platform.configuration.config can't be used as the fix
    ...
    _fake_config = _types.ModuleType("app.platform.configuration.config")
    ...
    _sys.modules["app.platform.configuration.config"] = _fake_config
