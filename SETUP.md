...
- **Database schema questions:** see [`database/README.md`](database/README.md) - the schema lives in `backend/app/models/` (platform-level entities) and `backend/app/modules/*/models.py` (business domains), plus `backend/alembic/versions/`, not a hand-written SQL file.
