...
export const ProductIcon = (p) => <svg {...base} {...p}><path d="M20.5 7.3 12 12l-8.5-4.7" /><path d="M12 12v9" /><path d="m4 7.3 8-4.6 8 4.6-8 4.7-8-4.7Z" /><path d="M20.5 7.3v9.4L12 21l-8.5-4.3V7.3" /></svg>;
...
/* Added for the Atelier Command Centre Home redesign (dashboard KPI
   strip / pipeline / production widgets) - same 24x24 stroke style as
   every icon above, no new dependency. */
export const TruckIcon = (p) => <svg {...base} {...p}><rect x="1" y="7" width="14" height="10" rx="1" /><path d="M15 10h4l3 3v4h-7z" /><circle cx="6" cy="19" r="1.8" /><circle cx="17.5" cy="19" r="1.8" /></svg>;
export const AlertTriangleIcon = (p) => <svg {...base} {...p}><path d="M12 3.5 22 20H2z" /><path d="M12 10v4" /><path d="M12 17h.01" /></svg>;
export const ArrowUpRightIcon = (p) => <svg {...base} {...p}><path d="M7 17L17 7" /><path d="M8 7h9v9" /></svg>;
export const CheckCircleIcon = (p) => <svg {...base} {...p}><circle cx="12" cy="12" r="9" /><path d="M8 12.5l2.5 2.5L16 9.5" /></svg>;
export const CompassIcon = (p) => <svg {...base} {...p}><circle cx="12" cy="12" r="9" /><path d="M15 9l-2 6-6 2 2-6z" /></svg>;
export const PrinterIcon = (p) => <svg {...base} {...p}><path d="M6 9V3h12v6" /><rect x="4" y="9" width="16" height="8" rx="1.5" /><path d="M6 14h12v7H6z" /></svg>;
